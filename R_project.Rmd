...
```{r price,message=FALSE, echo=FALSE, out.width="75%",out.height="50%", warning=FALSE, fig.cap="\\label{fig:figs}"}
# made from bitcoin_ether_price chunk with ggplot
knitr::include_graphics("Plots/price_compare.png")
```

```{r vol,message=FALSE, echo=FALSE, out.width="75%",out.height="50%", warning=FALSE, fig.cap="\\label{fig:figs}"}
...
```{r sum_stat,message=FALSE, echo=FALSE, out.width="50%",out.height="50%",warning=FALSE, fig.cap="\\label{fig:figs}"}
# made from bitcoin_ether_volume below with ggplot
...
```{r bitcoin_RF, , message=FALSE, echo=FALSE, warning=FALSE, out.width="75%",out.height="50%", fig.cap="\\label{fig:figs}"}
...
```{r RF_dependence_plot, message=FALSE, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:figs}"}
op <- par(mfrow=c(2, 3))
...
```{r ethereum_RF, , message=FALSE, echo=FALSE, warning=FALSE, out.width="75%", out.height="50%", fig.cap="\\label{fig:figs}"}
...
```{r RF_dependence_plot_ether, message=FALSE, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:figs}"}
...
```{r asset comparison, message=FALSE, echo=FALSE, warning=FALSE, include=TRUE, fig.cap="\\label{fig:figs}"}
