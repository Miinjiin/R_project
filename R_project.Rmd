...
The volatility of cryptocurrency price has both attracted and repelled myriads of investors around the world. However, year after year, we see more people investing in this volatile asset whether it is due to the opportunity to make life-changing money or the the curiosity towards the disruptive blockchain technology behind it. In this project, we first build the best predictive models to predict future prices of Bitcoin and Ethereum, the two largest cryptocurrencies in terms of market capitalization. We find that random forest model is the best predictor. Next, we compare and contrast the factors that contribute the most to the price prediction between the two assets, analyzed via variable importance and partial dependence plots. For both assets, S&P500 and 5-year inflation expectation are the biggest features contributing to their prices. Where they differ is the third most important variable, which are gold price and oil price for Bitcoin and Ehtereum, respectively. Utilizing these results, investors can make smart investment choices based on macroeconomic and market performance.
...
```{r bitcoin_RF, , message=FALSE, echo=FALSE, warning=FALSE, out.width="75%",out.height="50%", fig.cap="\\label{fig:figs}BTC Random Forest"}
