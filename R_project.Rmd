...
To sum up, our model will be useful to any crypto enthusiasts and market participants. 
...
```{r btcrf_beforeafter, message=FALSE, echo=FALSE, warning=FALSE, including=TRUE, out.width="50%", out.height="25%", fig.cap="\\label{fig:figs}BTC Variance Importance Plot pre-Covid"}
varImpPlot(bit_RF_pre, bg = "skyblue", cex=1, pch=22)
varImpPlot(bit_RF_post, bg = "skyblue", cex=1, pch=22)
```

```{r ethcrf_beforeafter, message=FALSE, echo=FALSE, warning=FALSE, including=TRUE, out.width="50%", out.height="25%",, fig.cap="\\label{fig:figs}ETH Variance Importance Plot pre-Covid"}
